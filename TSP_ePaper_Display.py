...
EPD_WIDTH = 640
EPD_HEIGHT = 384
TODOIST_TOKEN = '06cb21a2ea71730b425238d4bfd3a10fe36485c8'
WEATHER_API = '84a3fdb44c49195bd8ad26e9665c5887'
...
def main():
        ...
        global todo_wait; todo_wait = 3600
        global refresh_time; refresh_time = 7200
...
def query_weather():
    ...
    while True:
        try:
            weather_response = requests.get("http://api.openweathermap.org/data/2.5/weather?zip=L3R4V6,ca&appid=84a3fdb44c49195bd8ad26e9665c5887").json()
            forecast_response = requests.get("pro.openweathermap.org/data/2.5/forecast/hourly?zip=L3R4V6,ca&appid=84a3fdb44c49195bd8ad26e9665c5887").json()
            break
        except:
